...
vim.defer_fn(function()
  ...
  if current_default_path == vim.fn.expand("mdxsnaps_data/images/posts") and
     current_default_type == "relative" and
     (not config.options.ProjectOverrides or #config.options.ProjectOverrides == 0) then
    vim.notify(
